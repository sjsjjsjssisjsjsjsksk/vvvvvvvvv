...
const ftroli = {
  ...
  const jumlahUser = pendaftar.length
    ...
    const menulist = `
    70o0o0da BEH ${pushname} 👋.انا راي ${global.BotName}, بوت تم تطويري بواسطة: راي بيه للانتقال باستخدام واتساب إلى المستوى التالي.
...
*جروب 1*
https://chat.whatsapp.com/Bdsm1wW3CdD83mdSRTo11P
...
case 'support': case 'الدعم':
    ...
    reply(`*جروب الدعم:*https://chat.whatsapp.com/Bdsm1wW3CdD83mdSRTo11P `)
    break

case 'الشرح': case 'الوصف':
    
    reply(`**✶━━━✲─ • ❨🤖❩ • ─✲━━━✶
*أهلاً وسهلا بك في نقابة راي*
*نقابة راي ترحب بجميع النقابات*
...
*「 الامبراطور | راي 」◣*
*❁━─━─『💙』─━─━❁*
*『 https://wa.me/966504124495 』*
*❁━─━─『💙』─━─━❁  ┃↱*

ارجوكم ان تدعموني قناتي احتذفت
*↲┃ ┃↱*

*محتاج شيء كلمني موجود💙*
*✶━━━✲─ • ❨🤖❩ • ─✲━━━✶⌬*`)
    break
...
if (isBanChat) return reply(mess.bangc)
 ...
 if (!m.isGroup) return replay(mess.grouponly)
 if (!isAdmins && !isCreator) return replay(mess.useradmin)
 let teks = `══✪〘 *منشن جماعي لحبايب قلبي 💙👥* 〙✪══
...
「 مبروك سمو ابنكم طلال على اسمي 😂 」◣`
let menst = [orang, jodoh]
let buttons = [
{ buttonId: '「 لا مانبغى نبغى طلاق بالثلاث 」◣', buttonText: { displayText: '「 يب هم مناسبين لبعض😂🤡 」◣' }, type: 1 }
]
...
「 يلا يبنت خذي عيالك وانقلعي برا البيت  」◣`
let menst = [orang, jodoh]
let buttons = [
{ buttonId: '「 احسن الحب ماقتل نعجه عالفاضي 💔 」◣', buttonText: { displayText: '「 يب هم مش مناسبين لبعض 💔 」◣' }, type: 1 }
]
await Miku.sendButtonText(m.chat, buttons, jawab, Miku.user.name, m, {mentions: menst})
}
break
...
let ments = [me, jodoh]
let buttons = [
{ buttonId: '❤️', buttonText: { displayText: 'كن اخي الذي لم تلده امي ❤' }, type: 1 }
]
...
↲ *انا الامبراطور راي 🦇*, 
*تم تطويري بواسطة مخترعي راي الكسول*.↲

♠️ البادئة الخاصة بي هي:  ${prefix}
 
*✶━━━✲─ • ❨🤖❩ • ─✲━━━✶*
*اوامر قليل ولكن ممتعه*
*كيف صنع بوت وتس ملصقات* *وأوامر كثييره* 
*بوت اسطوره*
*رابط الفيديو📽️* ↲
*كل الروابط في التعليقات* 
*اذا واجهتك اي مشكله ادخل* *كلم مطوري راي الكسول*↲
https://chat.whatsapp.com/Bdsm1wW3CdD83mdSRTo11P
*تنورونا 💙*
*االاحترام اهم شيء↲
https://chat.whatsapp.com/Bdsm1wW3CdD83mdSRTo11P 
*نقابة راي تستقبلكم بكل الحالات 💙*↲
https://chat.whatsapp.com/Bdsm1wW3CdD83mdSRTo11P
*𝗥𝗔𝗶 | 𝗧𝗔𝗟𝗔𝗟*
*✶━━━✲─ • ❨اوامر اضافيه📀❩ • ─✲━━━✶*
↲بروفايل║
...
*✶━━━✲─ • ❨🤖❩ • ─✲━━━✶
🪷لا تستخدم المنشن كثير عشان ماتزعج الاعضاء
🪷اذا في مشكله كلمني وبحلها
...
🏖️ اكتب:  ${prefix} قبل كل امر ليعمل معك البوت
 ...
 『  *${global.BotName}*  』
*تم التطوير بواسطه: الامبراطور راي *
`
...
case 'راي': case 'الامبراطور':
    if (isBan) return reply(mess.banned)	 			
    if (isBanChat) return reply(mess.bangc)

const txt = ` راي بيحبك 💙 / رقمي للتواصل معايا:https://wa.me/966504124495    `
const mikuarray= [
