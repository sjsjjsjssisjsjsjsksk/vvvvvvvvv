...
console.log(color('\nمرحبًا ، أنا راي ، المطور الرئيسي لهذا البوت.\n\nشكرًا لاستخدام: ◤𝙀𝙈𝙋𝙀𝙍𝙊𝙍🦂𝘼𝙉𝙐𝙎◢','aqua'))
...
Miku.ev.on('group-participants.update', async (anu) => {
        ...
        try {
            ...
            for (let num of participants) {
                ...
                let WAuserName = num
                mikutext =
 *`أهلا وسهلا بك اذا كنت بنت انتي زوجتي وقمرتي الصغنونه واذا ولد نورت القروب ياعسل*@${WAuserName.split("@")[0]},

انا *الامبراطور راي*, مرحبا بك في ${metadata.subject}.
...
⚜️🦇, مع السلامه  |يروح يجي غيرك ياخاين!
`
